...
<head>
	...
	<style type="text/css">
* {
    background: none repeatscroll 0 0 transparent;
    border: 0 none;
    margin: 0;
    padding: 0;
...
var treeMenu = [
	{ level:1, name:"业务"},
	{ level:2, name:"显示房间列表", ico:"images/icon_default.gif",link:"serviceShowRoom.action"},
	{ level:2, name:"历史记录查询", ico:"images/icon_default.gif",link:"serviceCheck.jsp"},
	{ level:1, name:"财务"},
	{ level:2, name:"单笔记录", ico:"images/icon_default.gif",link:"serviceStroke.action"},
	{ level:2, name:"日营业额记录", ico:"images/icon_default.gif",link:"serviceAllday.action"}
];
</script>
